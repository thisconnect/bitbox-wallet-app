...
export function load<LoadedProps extends ObjectButNotFunction, ProvidedProps extends ObjectButNotFunction = {}>(
    ...
    return function decorator(
        WrappedComponent: JSXElementConstructor<LoadedProps & ProvidedProps>,
    ) {
        return class Load extends Component<ProvidedProps & Partial<LoadedProps>, Partial<LoadedProps>> {
            ...
            private allEndpointsLoaded(): boolean {
                ...
                if(this.state === null){
                    // TODO: see why state is null sometimes.
                    return false;
                }
            ...
            public render(): JSX.Element | null {
                ...
                return <WrappedComponent {...this.state} {...this.props as any} />; // This order allows the subscribe decorator (and others) to override the loaded endpoints with properties.
            }
        };
    };
}
